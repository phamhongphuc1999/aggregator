...
export default Object.seal({
	...
	config: Object.seal({
		...
		autoApproveAdjust: 0.0,
		autoApproveOrder: true,
		customApproveAdjust: 0.002,
		noTransferOuts: false,
		noAutoExpects: true,
		includeBlacklist: true,
		formatDatetime: '31536000',
		formatPrevToken: true,
		formatHalfDecimals: true,
	}),
	timeout: Object.seal({
		process: 40,
		execute: 3600,
	...
	cache: {
		names: {
			'0xfb4392e3431b9cc820362ad2b6a3fda4f8a7712d':
				'Automatic Aggregator Contract',
		},
		provider: {},
		def: {},
		user: {},
