	...
	call: new Call(
		...
		'aggregate(' +
			[
				...
				'(address,uint256)[]',
				'address[]',
				'((address,bytes,uint256),uint8,uint256,uint16)[]',
			].join(',') +
			')',
		['__calls__', '__ins__', '__outs__', '__expects__'],
		'__eth__',
		{
			title: 'Execute Aggregated Calls',
			params: [],
			returns: 'uint256 block,bytes[] memory results',
			gas: null,
		}
	),
	any: new View(
		'any((address,bytes,uint256)[])',
		['__calls__'],
		'uint256,bytes,uint16',
		1
	),
	delegate: 'transfer',
};
...
const swaps = {
	...
	call: new Call(
		...
		['__amount__', '__oamount__', '__path__', '__account__', '__ts__'],
		'0',
		{
			title: 'Universal token swap',
			params: [
				'Amount In',
				'Amount Out Min',
				'Swap Path',
	...
	auto: [
		...
		new Call(
			...
			['__amounts.0__', '__amounts.1__', '__account__', '0x'],
			'0',
			{
				title: 'Automatic swap',
				params: ['Amount 0 Out', 'Amount 1 Out', 'Receiver', 'Data'],
				gas: '87500',
			},
			tokenOutCheck
		),
	...
	call2e: new Call(
		...
		'0',
		{
			title: 'Shortcut to swap tokens to native',
			params: [
				'Amount In',
				'Amount Out Min',
				'Swap Path',
	...
	calle2: new Call(
		...
		['__oamount__', '__path__', '__account__', '__ts__'],
		'__amount__',
		{
...
const providinglps = {
	...
	calle: new Call(
		...
		'__amounts.0__',
		{
			title: 'Add liquidity (native)',
			params: [
				'Token address',
				'Amount token Desired',
				'Amount token Min',
				'Amount native Min',
				'Receiver',
				'Deadline',
	...
	create: new Call(
		...
		['__tokens.0__', '__tokens.1__'],
		'0',
		{
			title: 'Create liquidity pair',
			params: ['Token A', 'Token B'],
			gas: '60000',
		},
		new Check(
			new View('getPair(address,address)', [
				'__tokens.0__',
				'__tokens.1__',
			]),
			View.NOTEQUAL,
...
const wraps = {
	...
	call: new Call(
		...
		[],
		'__amount__',
		{ title: 'Wrap native token', gas: '56500' },
		new Check(
	...
	unwrap: new Call(
		...
		['__amount__'],
		'0',
		{ title: 'Unwrap native token', params: ['Amount'], gas: '48000' },
		new Check(
			getBalanceView('__account__', '__target__'),
			View.DECREASE,
			'__amount__'
